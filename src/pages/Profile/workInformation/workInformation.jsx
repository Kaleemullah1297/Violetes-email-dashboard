        ...
        <div className="card p-3 px-4">
          <div className="card-body">
            <div className="d-flex align-items-center">
              <i className="workInformation-card-icon fa-solid fa-building me-3 p-3"></i>
              <span className="lh-1">
            ...
            <div className="work-information-span">
              ...
              ></textarea>
              <small>
                A brief overview of your professional role and contributions
              </small>
            </div>
            <hr />
            ...
            <div className="d-flex work-information-footer p-3 mb-4">
              ...
              <div className="lh-1">
                ...
                <small>
                  This information helps colleagues understand your expertise
                  and find the right person for collaboration and support.
                </small>
              </div>
            </div>
          </div>
