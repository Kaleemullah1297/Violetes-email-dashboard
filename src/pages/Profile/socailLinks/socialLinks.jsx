      ...
      <div className="px-4 pt-4 mt-md-0 mt-3 me-md-0 me-3 mb-5 pb-5 social-links-card">
        <div className="div social_links">
          <div className="mb-4 py-3 d-flex align-items-center social_links-header">
            ...
            <span>
              <h5 className="m-0 p-0 ">Social Links</h5>
              ...
              <div className="social-links">
                ...
                <div className="social-links-footer ps-4 pb-3 pt-3 mb-2 d-flex">
                  ...
                  <span>
                    ...
                    <small>
                      Your social links will be visible to your contacts and in
                      your email signature when enabled. You can control
                      visibility in Display Settings.
                    </small>
                  </span>
                </div>
              </div>
