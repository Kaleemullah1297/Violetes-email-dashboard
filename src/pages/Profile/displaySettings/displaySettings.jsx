  ...
  return (
    ...
    <>
      <div className="px-4 pt-4 mt-md-0 mt-3 me-md-0 me-3 mb-5 pb-5">
        <div className="div display-settings">
          <div className="mb-4 py-3 d-flex align-items-center display-settings_header">
            <i className="bi bi-palette icon-1 fs-5 me-3 ms-4"></i>
            <span>
              <h5 className="m-0 p-0 ">Display Settings</h5>
              <small>Customize your interface and appearance</small>
            </span>
          </div>
